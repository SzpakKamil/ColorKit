...
This initializer allows you to define adaptive colors using hexadecimal string representations. It is designed to be robust, supporting strings with or without the `#` prefix, as well as 6-character (RGB) or 8-character (RGBA) formats.
