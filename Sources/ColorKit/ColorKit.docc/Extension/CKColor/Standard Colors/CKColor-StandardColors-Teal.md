...
Standard teal color. Adapts to system.

## Overview

`CKColor.teal` provides a platform-integrated teal color. Resolves to the appropriate system variant (such as `systemTeal` on iOS or macOS).
