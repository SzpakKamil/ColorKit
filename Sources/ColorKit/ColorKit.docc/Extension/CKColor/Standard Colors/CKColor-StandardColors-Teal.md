...
A standard teal color that adapts to the system environment.

## Overview

`CKColor.teal` provides a platform-integrated teal color. It automatically resolves to the appropriate system variant (such as `systemTeal` on iOS or macOS).
...
- **Gamut:** sRGB
- **Fallback Value:** RGB(0.0, 0.5, 0.5)
