...
@Metadata {
    ...
    @DisplayName("Purple", style: symbol)
...
A standard purple color that adapts to the system environment.

## Overview

`CKColor.purple` provides a platform-integrated purple color. It automatically resolves to the appropriate system variant (such as `systemPurple` on iOS or macOS).
...
- **Gamut:** sRGB
- **Fallback Value:** RGB(0.5, 0.0, 0.5)
