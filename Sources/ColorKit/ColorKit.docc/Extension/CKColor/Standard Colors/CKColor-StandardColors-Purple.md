...
Standard purple color. Adapts to system.

## Overview

`CKColor.purple` provides a platform-integrated purple color. Resolves to the appropriate system variant (such as `systemPurple` on iOS or macOS).
