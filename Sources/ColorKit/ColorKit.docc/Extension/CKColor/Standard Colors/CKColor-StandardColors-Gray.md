...
A standard gray color that adapts to the system environment.

## Overview

`CKColor.gray` provides a platform-integrated gray color. It automatically resolves to the appropriate system variant (such as `systemGray` on iOS or macOS).
