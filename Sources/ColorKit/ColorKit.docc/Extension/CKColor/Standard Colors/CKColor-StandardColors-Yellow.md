...
Standard yellow color. Adapts to system.

## Overview

`CKColor.yellow` provides a platform-integrated yellow color. Resolves to the appropriate system variant (such as `systemYellow` on iOS or macOS).
