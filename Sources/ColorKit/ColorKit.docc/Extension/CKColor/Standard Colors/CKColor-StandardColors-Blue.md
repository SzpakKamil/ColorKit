...
Standard blue color. Adapts to system.

## Overview

`CKColor.blue` provides a platform-integrated blue color. Resolves to the appropriate system variant (such as `systemBlue` on iOS or macOS).
