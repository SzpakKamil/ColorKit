...
Standard green color. Adapts to system.

## Overview

`CKColor.green` provides a platform-integrated green color. Resolves to the appropriate system variant (such as `systemGreen` on iOS or macOS).
